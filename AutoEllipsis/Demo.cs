...
namespace AutoEllipsis
{
	public partial class Demo : Form
	{
		...
		private void ellipsisMenuToolStripMenuItem_DropDownOpening(object sender, EventArgs e)
		{
			...
			menuItem1ToolStripMenuItem.Text = Ellipsis.Compact(labelEllipsis1.FullText, labelEllipsis1, CurrentEllipsisFormat);
		}
		...
		string CurrentText
		{
			set { textBoxEllipsis1.Text = labelEllipsis1.Text = value; }
		}

		EllipsisFormat CurrentEllipsisFormat
		{
			get
			{
